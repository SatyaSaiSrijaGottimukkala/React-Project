                ...
                >
                  <ChartistGraph
                    data={{
                      ...
                      labels: [((engineer.length/totaltype)*100).toString()+"%", ((contract.length/totaltype)*100).toString()+"%", ((manager.length/totaltype)*100).toString()+"%",((support.length/totaltype)*100).toString()+"%"],
                      
                        series: [((engineer.length/totaltype)*100), ((contract.length/totaltype)*100), ((manager.length/totaltype)*100),((support.length/totaltype)*100)],
